...
const (
	// Label holds the string label denoting the releasegroup type in the database.
	Label = "release_group"
	...
	// Table holds the table name of the releasegroup in the database.
	...
	EpisodesColumn = "release_group_id"
)

// Columns holds all SQL columns for releasegroup fields.
var Columns = []string{
	FieldID,
	FieldName,
}
